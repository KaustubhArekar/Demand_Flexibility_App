...
# --------------------------------------------------------------------------------
 ...
 #______________________________________________________________________________________________________   
    ...
    # plt.plot(battery_profile.iloc[:,0])
    # plt.plot(batt_soc.iloc[:,0])
    # dataframe to csv
...
#     per_unit_generation_cost = total_generation_cost/(projected_demand['demand']-re.sum(axis=1)-market_power.iloc[:,0])
#     per_unit_generation_cost = total_generation_cost/(projected_demand['demand']-re.sum(axis=1)-market_power.iloc[:,0])
    # per_unit_generation_cost = total_generation_cost/(projected_demand['demand'] +market_power.iloc[:,0])
    per_unit_generation_cost = total_generation_cost/(projected_demand['demand'] + battery_profile.iloc[:,0]+market_power.iloc[:,0])
...
#     print('Time taken for optimisation:',total_time1)
    ...
    return  per_unit_generation_cost , market_power, battery_profile, total_generation_cost
